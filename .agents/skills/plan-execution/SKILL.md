...
description: >-
  ...
  plan-backed issue branch. NOT for writing the plan — see the
  implementation-planning skill. NOT for a plan you produced with the user in
  this same session, where the notes artifact and plan-directory lifecycle do
  not apply.
---
