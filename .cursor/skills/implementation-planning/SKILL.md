...
description:
  Write a detailed, evidence-backed implementation plan for a firestore-orm issue or change, saved
  to tmp/plans/. Use when asked to plan/scope/spec a change, break down an issue, or hand work off
  to another agent before any code is written. NOT for writing the code itself, and not for trivial
