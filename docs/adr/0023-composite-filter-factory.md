...
(#34–#41) and the decision not to pursue full server-side or Enterprise Pipeline parity are
unchanged. (#31 collection groups, #32 transaction options, and #33 conditional writes have since
shipped — see ADR-0024 / ADR-0025 / ADR-0026; this footer is kept as a living index — see
