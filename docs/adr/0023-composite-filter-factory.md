...
(#35–#41) and the decision not to pursue full server-side or Enterprise Pipeline parity are
unchanged. (#31 collection groups, #32 transaction options, #33 conditional writes, and #34 generic
multi-aggregation have since shipped — see ADR-0024 / ADR-0025 / ADR-0026 / ADR-0027; this footer is
