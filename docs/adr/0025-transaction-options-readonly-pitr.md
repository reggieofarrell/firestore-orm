...
bounds / `limitToLast`, #37 `explain()`, and #38 `bulkWrite` / `recursiveDelete` have since shipped
— see ADR-0026 / ADR-0027 / ADR-0029 / ADR-0030 / ADR-0031 / ADR-0032; this footer is a living index
