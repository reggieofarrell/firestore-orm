...
are unchanged. (#35 `getMany`, #36 typed bounds / `limitToLast`, and #37 `explain()` have since
shipped — see ADR-0029 / ADR-0030 / ADR-0031; this footer is a living index of remaining ADR-0017
