...
[Dot-notation nested updates](./dot-notation.md) for the merge semantics of paths like
`'profile.nickname'`.
...
[lifecycle hooks](./lifecycle-hooks.md); use the per-document or bulk repository methods when you
need hook side effects.
