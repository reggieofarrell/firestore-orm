...
costs on large collections — see [Performance](./performance.md) for the full cost model.
...
> per-document hooks (see [Lifecycle hooks](./lifecycle-hooks.md)), iterate and call the
