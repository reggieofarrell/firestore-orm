...
The library surfaces this as a `FirestoreIndexError` (see [Error handling](./error-handling.md)),
...
> [Lifecycle hooks](./lifecycle-hooks.md) and [Transactions](./transactions.md).
...
field you filter on. See [Queries](./queries.md) for the full query-builder surface.
...
repository. See [Subcollections](./subcollections.md) for more.
...
See [Dot-notation nested updates](./dot-notation.md) and [Transactions](./transactions.md) for
details.
